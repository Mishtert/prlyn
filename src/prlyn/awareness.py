...
def apply_model_awareness(result: AnalysisResult, model_name: Optional[str] = None) -> AnalysisResult:
    if not model_name:
        return result
    ...
    if result.position_score:
        ...
        if retrieval == "poor" and result.position_score.buried_instructions:
            ...
            result.position_score.score = max(0.0, result.position_score.score - penalty)
