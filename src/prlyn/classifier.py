...
IMPERATIVE_VERBS = {
    "write", "create", "generate", "make", "build", "implement", "code",
    "explain", "describe", "summarize", "translate", "list", "compare",
    "analyze", "fix", "update", "add", "remove", "delete", "use", "act",
    "ignore", "return", "provide", "output", "ensure", "check", "verify"
}
...
class Classifier:
    ...
    def classify(self, text: str) -> List[ClassifiedSentence]:
        ...
        for sent in doc.sents:
            ...
            is_imperative = (root.pos_ == "VERB" and root.lemma_.lower() in IMPERATIVE_VERBS)
            ...
            format_keywords = ["json", "csv", "markdown", "xml", "format", "output", "structure"]
            ...
            secondary = [l for l in labels if l != primary]
            
            classified_sentences.append(ClassifiedSentence(
