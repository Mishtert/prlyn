...
class PositionAnalyzer:
    def analyze(self, sentences: List[ClassifiedSentence], text_length: int) -> PositionScore:
        if text_length == 0:
            return PositionScore(start_density=0, middle_density=0, end_density=0, buried_instructions=[], score=0)
        ...
        for i, sent in enumerate(sentences):
            ...
            is_critical = sent.primary_label in {SentenceLabel.INSTRUCTION, SentenceLabel.CONSTRAINT}
        ...
        if total_critical == 0:
             return PositionScore(start_density=0, middle_density=0, end_density=0, buried_instructions=[], score=1.0)
