...
from prlyn.models import RedundancyScore, RedundancyCluster, ClassifiedSentence, SentenceLabel
...
class RedundancyAnalyzer:
    ...
    def analyze(self, sentences: List[ClassifiedSentence]) -> RedundancyScore:
        ...
        for idx, s in enumerate(sentences):
            ...
            if s.primary_label not in {SentenceLabel.INSTRUCTION, SentenceLabel.CONSTRAINT, SentenceLabel.FORMAT_SPEC}:
                continue
        ...
        for label, indices in grouped.items():
            ...
            for i, cluster_id in enumerate(labels):
                ...
                cluster_map[cluster_id].append(indices[i])
            ...
            for cid, idxs in cluster_map.items():
                if len(idxs) > 1:
                    ...
                    clusters_found.append(RedundancyCluster(
                        label=label,
