...
VAGUE_TERMS = {
    "some", "few", "many", "several", "things", "stuff", "various", "certain",
    "kind of", "sort of", "roughly", "about", "approximately", "something"
}

HEDGING_TERMS = {
    "might", "may", "could", "can", "possibly", "probably", "likely", "usually",
    "often", "sometimes", "generally", "seem", "appear", "suggest", "think",
    "believe", "assume"
}
