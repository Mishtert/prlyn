...
class Analyzer:
    def __init__(self):
        ...
        try:
            ...
            self.contradiction_analyzer = ContradictionAnalyzer(self.redundancy_analyzer.model)
    ...
    def analyze(self, raw_text: str, model_name: Optional[str] = None) -> AnalysisResult:
        """
        ...
        readability_score = self.readability_analyzer.analyze(clean_text, total_sentences=len(sentences))
